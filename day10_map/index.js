...
const displacementTexture = new THREE.TextureLoader().load('editedBump.jpg')
const speculatMapTextureReversed = new THREE.TextureLoader().load('8081_earthspec2kReversedLighten.png')
const bumpTexture = new THREE.TextureLoader().load('8081_earthbump2k.jpg')
const speculatMapTexture = new THREE.TextureLoader().load('8081_earthspec2k.jpg')
// 帶入材質，設定內外面
