...
const column1 = addCube(4, 50, 4, 0x888888, THREE.FrontSide);
column1.position.set(-10, 0, -20);
const column2 = addCube(4, 50, 4, 0x888888, THREE.FrontSide);
column2.position.set(10, 0, -20);
const column3 = addCube(4, 50, 4, 0x888888, THREE.FrontSide);
column3.position.set(10, 0, 20);
const column4 = addCube(4, 50, 4, 0x888888, THREE.FrontSide);
